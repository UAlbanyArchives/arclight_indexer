...
class SolrCollection(models.Base):
    ...
    type_ssim = fields.ListField(str)
    accession_ssim = fields.ListField(str)
    processing_activity_ssim = fields.ListField(str)
    accession_ssim = fields.ListField(str)
    processing_activity_ssim = fields.ListField(str)
    contributor_ssim = fields.ListField(str)
    description_ssim = fields.ListField(str)
    abstract_ssim = fields.ListField(str)
    keyword_ssim = fields.ListField(str)
    physical_dimensions_ssim = fields.ListField(str)
    preservation_format_ssim = fields.StringField()
    date_digitized_ssim = fields.StringField()
    legacy_identifier_ssim = fields.ListField(str)
    original_format_ssim = fields.ListField(str)
