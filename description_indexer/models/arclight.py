...
class SolrCollection(models.Base):
    ...
    type_ssi = fields.ListField(str)
    accession_ssi = fields.ListField(str)
    processing_activity_ssi = fields.ListField(str)
    accession_ssi = fields.ListField(str)
    processing_activity_ssi = fields.ListField(str)
    contributor_ssi = fields.ListField(str)
    description_ssi = fields.ListField(str)
    abstract_ssi = fields.ListField(str)
    keyword_ssi = fields.ListField(str)
    physical_dimensions_ssi = fields.ListField(str)
    preservation_format_ssi = fields.StringField()
    date_digitized_ssi = fields.StringField()
    legacy_identifier_ssi = fields.ListField(str)
    original_format_ssi = fields.ListField(str)
